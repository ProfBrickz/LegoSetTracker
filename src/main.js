...
import { DATA_PATH, IMAGES_PATH, IS_BUILT, IS_DEV_MODE, LAYOUTS_PATH, MINIFIG_IMAGES_PATH, PAGES_PATH, PIECE_IMAGES_PATH, PRELOAD_FILE, SET_IMAGES_PATH } from "./constants.js";
...
// Setup
if (!IS_BUILT && !fs.existsSync(DATA_PATH)) fs.mkdirSync(DATA_PATH);
await database.init();
